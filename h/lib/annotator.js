...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    function Annotator(element, options) {
      ...
      this.pdfMode = (_ref1 = typeof PDFView !== "undefined" && PDFView !== null ? PDFView.initialized : void 0) != null ? _ref1 : false;
    ...
    Annotator.prototype._setupMatching = function() {
      ...
      this.pdfMapper = new PDFTextMapper();
      return this;
    };

    Annotator.prototype._scan = function() {
      if (this.pdfMode) {
        return this.pdfMapper.scan();
      } else {
